...
void drawMemberPage(windowModel *windowM)
{
    ...
    windowM->members[2] = (Member){.nama = "Teguh Bayu Pratama ", .julukan = "Master Programmer", .domisili = "Palu", .nim = "0920250052", .tanggalLahir = "17 Juni 2007", .image = windowM->members[2].image};
    ...
    windowM->members[4] = (Member){.nama = "Nabilah Tri Utami", .julukan = "Pacar Martin", .domisili = "Brebes", .nim = "0920250044", .tanggalLahir = "03 September 2007", .image = windowM->members[4].image};
